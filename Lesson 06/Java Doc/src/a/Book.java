...
public class Book {
	...
	/** a list of all authors of this book */
	private String[] authors = new String[5];
	/** the of this book */
	private double price;

	// CTOR
	/** this CTOR create a book object with title, authors and price */
	...
	/**
	 * this method adds an outhor to this book array of authors. if the array is
	 * full, a bigger array will be created
	 */
